...
export default function TrackerBar({ trackers, activeTrackerId, onSelect, onRename, onNew, onLogout, userEmail }: TrackerBarProps) {
  ...
  return (
    <div className="flex gap-1.5 sm:gap-2 items-center flex-wrap mb-3 pb-3 border-b border-slate-200 dark:border-slate-800">
      <div className="flex gap-1.5 sm:gap-2 items-center overflow-x-auto scrollbar-hide min-w-0 flex-1">
        {trackers.map(t => (
          <button
            key={t.id}
