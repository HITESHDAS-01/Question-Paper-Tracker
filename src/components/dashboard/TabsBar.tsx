    ...
    <div className="mb-4">
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="flex-1 min-w-0 overflow-x-auto scrollbar-hide">
          <div className="flex gap-1 bg-slate-100 dark:bg-slate-800 rounded-lg p-1 w-max">
            {views.map(v => (
              <button
                key={v.key}
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          ...
          <div className="relative">
            <button
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-lg text-[11px] sm:text-xs font-medium text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
